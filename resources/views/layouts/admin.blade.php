...
<head>
    ...
    <meta http-equiv="Content-Security-Policy"
        content="default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://unpkg.com http://localhost:* ws://localhost:*; style-src 'self' 'unsafe-inline' https://fonts.bunny.net http://localhost:*; font-src 'self' https://fonts.bunny.net data:; img-src 'self' data: https:; connect-src 'self' http://localhost:* ws://localhost:*;">
    --}}
        ...
        <aside :class="{'translate-x-0': sidebarOpen, '-translate-x-full': !sidebarOpen}"
            ...
            <div class="p-6 border-b bg-white flex items-center justify-between">
                <div class="bg-gray-100 rounded-lg p-3 flex items-center justify-center flex-1">
                    <img src="{{ asset('assets/logo-seminaireexpo.png') }}" alt="SeminairExpo Logo"
            ...
            <nav class="p-4 space-y-2">
                <a href="{{ route('dashboard') }}" @click="sidebarOpen = false" class="group relative flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200
                        ...
                        @endif>
                    <div class="relative">
                        <i data-lucide="layout-dashboard" class="w-5 h-5 transition-colors relative z-10"
                            style="@if(request()->routeIs('dashboard')) color: #00adf1; @else color: #6b7280; @endif"></i>
                        @if(request()->routeIs('dashboard'))
                ...
                <a href="{{ route('admin.events.index') }}" @click="sidebarOpen = false" class="group relative flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200
                          @if(request()->routeIs('admin.events.*'))
                            font-semibold shadow-lg
                          @else
                            hover:bg-gray-50 text-gray-700 hover:text-gray-900
                          @endif" @if(request()->routeIs('admin.events.*'))
                        ...
                        @endif>
                    <div class="relative">
                        <i data-lucide="building" class="w-5 h-5 transition-colors relative z-10"
                            style="@if(request()->routeIs('admin.events.*')) color: #83ce2f; @else color: #6b7280; @endif"></i>
                        @if(request()->routeIs('admin.events.*'))
                ...
                <a href="{{ route('admin.event-packages.index') }}" @click="sidebarOpen = false" class="group relative flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200
                          @if(request()->routeIs('admin.event-packages.*'))
                            font-semibold shadow-lg
                          @else
                            hover:bg-gray-50 text-gray-700 hover:text-gray-900
                          @endif" @if(request()->routeIs('admin.event-packages.*'))
                        ...
                        @endif>
                    <div class="relative">
                        <i data-lucide="package" class="w-5 h-5 transition-colors relative z-10"
                            style="@if(request()->routeIs('admin.event-packages.*')) color: #eb0b69; @else color: #6b7280; @endif"></i>
                        @if(request()->routeIs('admin.event-packages.*'))
                ...
                <a href="{{ route('admin.standalone.flights.index') }}" @click="sidebarOpen = false" class="group relative flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200
                          @if(request()->routeIs('admin.standalone.flights.*'))
                            font-semibold shadow-lg
                          @else
                            hover:bg-gray-50 text-gray-700 hover:text-gray-900
                          @endif" @if(request()->routeIs('admin.standalone.flights.*'))
                            style="background: linear-gradient(135deg, rgba(0, 173, 241, 0.15) 0%, rgba(0, 173, 241, 0.05) 100%); color: #00adf1; border: 2px solid rgba(0, 173, 241, 0.3); box-shadow: 0 4px 12px rgba(0, 173, 241, 0.15);"
                        @endif>
                    <div class="relative">
                        <i data-lucide="plane" class="w-5 h-5 transition-colors relative z-10"
                            style="@if(request()->routeIs('admin.standalone.flights.*')) color: #00adf1; @else color: #6b7280; @endif"></i>
                        @if(request()->routeIs('admin.standalone.flights.*'))
                            <div class="absolute inset-0 bg-blue-100 rounded-full blur-sm opacity-50"></div>
                        @endif
                    </div>
                ...
                <a href="{{ route('admin.transfers.global-index') }}" @click="sidebarOpen = false" class="group relative flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200
                          @if(request()->routeIs('admin.transfers.*'))
                            font-semibold shadow-lg
                          @else
                            hover:bg-gray-50 text-gray-700 hover:text-gray-900
                          @endif" @if(request()->routeIs('admin.transfers.*'))
                            style="background: linear-gradient(135deg, rgba(59, 130, 246, 0.15) 0%, rgba(59, 130, 246, 0.05) 100%); color: #2563eb; border: 2px solid rgba(59, 130, 246, 0.3); box-shadow: 0 4px 12px rgba(59, 130, 246, 0.15);"
                        @endif>
                    <div class="relative">
                        <i data-lucide="car" class="w-5 h-5 transition-colors relative z-10"
                            style="@if(request()->routeIs('admin.transfers.*')) color: #2563eb; @else color: #6b7280; @endif"></i>
                        @if(request()->routeIs('admin.transfers.*'))
                            <div class="absolute inset-0 bg-blue-100 rounded-full blur-sm opacity-50"></div>
                        @endif
                    </div>
                    ...
                    @if(request()->routeIs('admin.transfers.*'))
                        <div class="ml-auto flex items-center gap-1">
                            <div class="w-1.5 h-1.5 rounded-full" style="background-color: #2563eb;"></div>
                            <div class="w-1 h-1 rounded-full opacity-60" style="background-color: #2563eb;"></div>
                        </div>
                    @endif
                </a>


                <a href="{{ route('admin.bookings.index') }}" @click="sidebarOpen = false" class="group relative flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200
                          @if(request()->routeIs('admin.bookings.*'))
                            font-semibold shadow-lg
                          @else
                            hover:bg-gray-50 text-gray-700 hover:text-gray-900
                          @endif" @if(request()->routeIs('admin.bookings.*'))
                        ...
                        @endif>
                    <div class="relative">
                        <i data-lucide="file-text" class="w-5 h-5 transition-colors relative z-10"
                            style="@if(request()->routeIs('admin.bookings.*')) color: #8c1790; @else color: #6b7280; @endif"></i>
                        @if(request()->routeIs('admin.bookings.*'))
                ...
                <a href="{{ route('admin.invoices.index') }}" @click="sidebarOpen = false" class="group relative flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200
                          @if(request()->routeIs('admin.invoices.*'))
                            font-semibold shadow-lg
                          @else
                            hover:bg-gray-50 text-gray-700 hover:text-gray-900
                          @endif" @if(request()->routeIs('admin.invoices.*'))
                        ...
                        @endif>
                    <div class="relative">
                        <i data-lucide="receipt" class="w-5 h-5 transition-colors relative z-10"
                            style="@if(request()->routeIs('admin.invoices.*')) color: #ea5d25; @else color: #6b7280; @endif"></i>
                        @if(request()->routeIs('admin.invoices.*'))
                ...
                @if(auth()->user()?->isSuperAdmin())
                    <a href="{{ route('admin.newsletter.index') }}" @click="sidebarOpen = false" class="group relative flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200
                                  @if(request()->routeIs('admin.newsletter.*'))
                                    font-semibold shadow-lg
                                  @else
                                    hover:bg-gray-50 text-gray-700 hover:text-gray-900
                                  @endif" @if(request()->routeIs('admin.newsletter.*'))
                                ...
                                @endif>
                        <div class="relative">
                            <i data-lucide="mail" class="w-5 h-5 transition-colors relative z-10"
                                style="@if(request()->routeIs('admin.newsletter.*')) color: #3b82f6; @else color: #6b7280; @endif"></i>
                            @if(request()->routeIs('admin.newsletter.*'))
                                <div class="absolute inset-0 bg-blue-100 rounded-full blur-sm opacity-50"></div>
                            @endif
                        </div>
                ...
                @can('viewAny', App\Models\User::class)
                    <a href="{{ route('admin.admins.index') }}" @click="sidebarOpen = false" class="group relative flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200
                                  @if(request()->routeIs('admin.admins.*'))
                                    font-semibold shadow-lg
                                  @else
                                    hover:bg-gray-50 text-gray-700 hover:text-gray-900
                                  @endif" @if(request()->routeIs('admin.admins.*'))
                                ...
                                @endif>
                        <div class="relative">
                            <i data-lucide="users" class="w-5 h-5 transition-colors relative z-10"
                                style="@if(request()->routeIs('admin.admins.*')) color: #b71354; @else color: #6b7280; @endif"></i>
                            @if(request()->routeIs('admin.admins.*'))
                                <div class="absolute inset-0 bg-pink-100 rounded-full blur-sm opacity-50"></div>
                            @endif
                        </div>
                ...
                @if(auth()->user()?->isSuperAdmin())
                    <a href="{{ route('admin.users.index') }}" @click="sidebarOpen = false" class="group relative flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200
                                ...
                                @endif>
                        <div class="relative">
                            <i data-lucide="user-circle" class="w-5 h-5 transition-colors relative z-10"
                                style="@if(request()->routeIs('admin.users.*')) color: #37ac9c; @else color: #6b7280; @endif"></i>
                            @if(request()->routeIs('admin.users.*'))
                ...
                @if(auth()->user()?->isSuperAdmin())
                    <a href="{{ route('admin.logs.index') }}" @click="sidebarOpen = false" class="group relative flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200
                                  @if(request()->routeIs('admin.logs.*'))
                                    font-semibold shadow-lg
                                  @else
                                    hover:bg-gray-50 text-gray-700 hover:text-gray-900
                                  @endif" @if(request()->routeIs('admin.logs.*'))
                                ...
                                @endif>
                        <div class="relative">
                            <i data-lucide="scroll-text" class="w-5 h-5 transition-colors relative z-10"
                                style="@if(request()->routeIs('admin.logs.*')) color: #111827; @else color: #6b7280; @endif"></i>
                            @if(request()->routeIs('admin.logs.*'))
                ...
                <div class="px-4 sm:px-6 py-4 flex items-center justify-between lg:justify-end">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex items-center gap-2 bg-gray-50 rounded-lg p-1">
                            ...
                            <a href="{{ $enUrl }}" class="flex items-center gap-2 px-3 py-2 rounded-md transition-all duration-200
                                      {{ app()->getLocale() == 'en'
    ? 'bg-white shadow-sm border border-gray-200'
    : 'hover:bg-gray-100' }}">
                                <img src="{{ asset('assets/english.png') }}" alt="English"
                                    class="w-5 h-5 object-contain">
                                <span
                                    class="text-sm font-medium {{ app()->getLocale() == 'en' ? 'text-gray-900' : 'text-gray-600' }}">EN</span>
                            </a>

                            <a href="{{ $frUrl }}" class="flex items-center gap-2 px-3 py-2 rounded-md transition-all duration-200
                                      {{ app()->getLocale() == 'fr'
    ? 'bg-white shadow-sm border border-gray-200'
    : 'hover:bg-gray-100' }}">
                                <img src="{{ asset('assets/french.png') }}" alt="Français"
                                    class="w-5 h-5 object-contain">
                                <span
                                    class="text-sm font-medium {{ app()->getLocale() == 'fr' ? 'text-gray-900' : 'text-gray-600' }}">FR</span>
                            </a>
                        </div>
                        ...
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button
                                    class="flex items-center gap-3 px-4 py-2 rounded-lg border border-gray-200 bg-white hover:bg-gray-50 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2"
                                    style="--tw-ring-color: #00adf1;">
                    ...
                    <div class="max-w-7xl mx-auto flex items-center justify-between gap-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="text-sm">
                                ...
                                <span class="text-yellow-800">{{ auth()->user()->name }}
                        ...
                        <form method="POST" action="{{ route('admin.impersonate.stop') }}" class="inline">
                            @csrf
                            <button type="submit"
                                class="px-4 py-2 bg-yellow-600 hover:bg-yellow-700 text-black text-sm font-medium rounded-lg transition-colors duration-200 flex items-center gap-2">
