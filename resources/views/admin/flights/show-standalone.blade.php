...
<div class="space-y-6">
  <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    ...
    <div class="flex gap-2">
      <a href="{{ route('admin.standalone.flights.index') }}" class="px-4 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600 transition-all">
        Back to Flights
      </a>
      <a href="{{ route('admin.standalone.flights.edit', $flight) }}" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-all">
        Edit
      </a>
    </div>
  </div>
          ...
          <div class="space-y-2">
            ...
            @if($flight->beneficiary_type === 'client')
              ...
              @if($flight->credentials_pdf_path)
                <div>
                  <a href="{{ route('admin.standalone.flights.downloadCredentials', $flight) }}" 
