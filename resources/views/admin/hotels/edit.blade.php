        ...
        <x-shadcn.card-content class="p-6">
                    <form method="POST" action="{{ route('admin.hotels.update', $hotel) }}" enctype="multipart/form-data">
                        ...
                        @if(auth()->user()->isSuperAdmin() && $admins->count() > 0)
                            <div class="mt-6 mb-6 p-4 border border-gray-300 rounded-md bg-gray-50">
                                ...
                                <p class="mt-1 mb-3 text-sm text-gray-600">
                                    Select admins who should be able to edit this hotel even if they didn't create it.
                                </p>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="duration" class="block mt-1 w-full" type="text" name="duration" :value="old('duration', $hotel->duration)" placeholder="e.g., 15 min, 30 minutes, 1 hour" />
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description_en" name="description_en" rows="4" class="block mt-1 w-full bg-white text-gray-900 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('description_en', $hotel->description_en) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description_fr" name="description_fr" rows="4" class="block mt-1 w-full bg-white text-gray-900 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('description_fr', $hotel->description_fr) }}</textarea>
