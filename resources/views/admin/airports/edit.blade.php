...
<div class="space-y-6">
    ...
    <x-shadcn.card class="shadow-lg">
        <x-shadcn.card-content class="p-6">
            <form method="POST" action="{{ route('admin.events.airports.update', [$event, $airport]) }}">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $airport->name)" required autofocus placeholder="e.g., Mohammed V International Airport" />
                        <x-input-error :messages="$errors->get('name')" class="mt-2" />
                    </div>

                    <div>
                        <x-input-label for="code" value="Airport Code" />
                        <x-text-input id="code" class="block mt-1 w-full" type="text" name="code" :value="old('code', $airport->code)" maxlength="10" placeholder="e.g., CMN, RAK" />
                    ...
                    <div>
                        ...
                        <x-text-input id="city" class="block mt-1 w-full" type="text" name="city" :value="old('city', $airport->city)" placeholder="e.g., Casablanca" />
                        <x-input-error :messages="$errors->get('city')" class="mt-2" />
                    </div>

                    <div>
                        <x-input-label for="country" value="Country" />
                        <x-text-input id="country" class="block mt-1 w-full" type="text" name="country" :value="old('country', $airport->country)" placeholder="e.g., Morocco" />
                    ...
                    <div>
                        ...
                        <x-text-input id="distance_from_venue" class="block mt-1 w-full" type="number" step="0.01" name="distance_from_venue" :value="old('distance_from_venue', $airport->distance_from_venue)" min="0" placeholder="0.00" />
                    ...
                    <div>
                        ...
                        <x-text-input id="sort_order" class="block mt-1 w-full" type="number" name="sort_order" :value="old('sort_order', $airport->sort_order)" min="0" />
                    ...
                    <div class="flex items-center">
                        <label class="flex items-center">
                            <input type="checkbox" name="active" value="1" {{ old('active', $airport->active) ? 'checked' : '' }} class="rounded border-gray-300">
