                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="passengers" class="block mt-1 w-full" type="number" name="passengers"
                                    min="1" :value="old('passengers', 1)" required oninput="updateAdditionalPassengers()" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-text-input id="driver_name" class="block mt-1 w-full" type="text" name="driver_name"
                                    :value="old('driver_name')" placeholder="Ex: Ahmed" />
                            ...
                            <div>
                                ...
                                <x-text-input id="driver_phone" class="block mt-1 w-full" type="text" name="driver_phone"
                                    :value="old('driver_phone')" placeholder="Ex: +212 600..." />
    ...
    @push('scripts')
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // If there's old data, it might not be perfect with this dynamic logic 
                // but usually handled by form state if needed.
